...
@testset "SimpleModel with GaussianHjmModelStatic methods." begin
    ...
    hjm_model_dom = DiffFusion.gaussian_hjm_model_static("USD",delta_dom,chi_dom,sigma_f_dom,ch,nothing)
    ...
    hjm_model_for = DiffFusion.gaussian_hjm_model_static("EUR",delta_for,chi_for,sigma_f_for,ch,asset_model)

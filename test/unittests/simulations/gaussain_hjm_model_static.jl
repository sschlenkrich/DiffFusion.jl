...
@testset "GaussianHjmModelStatic simulation." begin
    ...
    hjm_model = DiffFusion.gaussian_hjm_model_static("Std_no_corr",delta,chi,sigma_f,ch,nothing)
    ...
    @testset "Simple simulation HJM with correlation." begin
        hjm_model_w_corr = DiffFusion.gaussian_hjm_model_static("EUR",delta,chi,sigma_f,ch,nothing)
        times = 0.0:2.0:10.0
        n_paths = 2^10
